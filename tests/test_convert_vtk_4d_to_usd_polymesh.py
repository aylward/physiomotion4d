...
class TestConvertVTK4DToUSDPolyMesh:
    ...
    def test_convert_multiple_time_points(self, contour_meshes, test_directories):
        ...
        converter = ConvertVTK4DToUSDPolyMesh(
            data_basename="HeartMulti",
            input_polydata=contour_meshes,
            mask_ids=None
        )
    ...
    def test_convert_with_deformation(self, contour_tools, segmentation_results, test_directories):
        ...
        converter = ConvertVTK4DToUSDPolyMesh(
            data_basename="HeartDeformation",
            input_polydata=[contours],
            mask_ids=None
        )
    ...
    def test_usd_file_structure(self, contour_meshes, test_directories):
        ...
        transform_prim = stage.GetPrimAtPath("/World/HeartStructure/Transform_heart_structure_test")
        assert transform_prim.IsValid(), f"Transform prim not found at /World/HeartStructure/Transform_heart_structure_test"
    ...
    def test_time_varying_topology(self, contour_meshes, test_directories):
        ...
        converter = ConvertVTK4DToUSDPolyMesh(
            data_basename="HeartVarying",
            input_polydata=[mesh1, mesh2],
            mask_ids=None
        )
    ...
    def test_batch_conversion(self, contour_tools, segmentation_results, test_directories):
